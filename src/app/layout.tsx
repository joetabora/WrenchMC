        ...
        <ClientProviders>
          <div className="flex min-h-screen">
            ...
            <div className="flex-1 lg:ml-64">
              ...
              {/* Mobile Header */}
              <header className="lg:hidden sticky top-0 z-40 flex items-center justify-between px-4 py-3 border-b border-glass-border bg-wrench/90 backdrop-blur-xl pt-safe">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-gradient-flame flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                      <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" />
                    </svg>
                  </div>
                  <span className="font-semibold text-wrench-text-primary">WrenchMC</span>
                </div>
                <HeaderActions />
              </header>

              {/* Main Content Area */}
              <main className="relative flex-grow pb-nav-safe lg:pb-0">
                {children}
              </main>
