  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden py-20 md:py-32">
        ...
        <div className="relative max-w-6xl mx-auto px-4 text-center">
          ...
          >
            ...
            >
              <Wrench className="w-16 h-16 text-wrench-accent" />
            </motion.div>
            ...
            <p className="text-2xl md:text-3xl font-bold text-wrench-accent mb-12">
      ...
      <section className="py-20 px-4">
        ...
        >
          <Card className="text-center bg-gradient-accent/10 border-wrench-accent/30">
            <Zap className="w-12 h-12 text-wrench-accent mx-auto mb-4" />
