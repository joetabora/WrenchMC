...
4. Click **Save**
5. **Important**: Redeploy your application for the change to take effect
...
- Very cost-effective for bulk imports

### Tips to Reduce Costs

1. **Clean your source text** - Remove unnecessary content before pasting
2. **Batch similar content** - Extract multiple specs in one go
